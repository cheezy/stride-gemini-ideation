...
# commands/stridify.toml (W1154; ports upstream G235/W1140).
#
# Gemini CLI's question UI is only available inside a live Gemini CLI session,
...
# Step 1 and Step 8.5 in commands/stridify.toml and with the
...
# Mirrors commands/stridify.toml Step 1. Returns a hashtable @{ AutoApprove; Remainder }.
...
# Mirrors commands/stridify.toml Step 8.5a. Reads ONLY the on-disk batch JSON (no auth
...
# Mirrors commands/stridify.toml Step 8.5 a/b/c. Writes the combined output to $LogPath. On
