...
# commands/stridify.toml (W1154; ports upstream G235/W1140). Gemini CLI's question UI is
# only available inside a live Gemini CLI session, so this test embeds a
...
# Step 8.5 in commands/stridify.toml. If you edit one, edit
...
#
# Mirrors commands/stridify.toml Step 1. --yes and --auto-approve are bare boolean tokens
...
#
# Mirrors commands/stridify.toml Step 8.5 a/b/c. Args:
