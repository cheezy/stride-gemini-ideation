...
# documented in commands/ideate.toml (W1151; ports upstream G235/W1137). The platform
# file-read / question UI is only available inside a live Gemini CLI session,
...
# commands/ideate.toml, and with the PowerShell mirror
...
#
# Mirrors commands/ideate.toml Step 1: parse --continue and --input (each in both
...
#
# Mirrors commands/ideate.toml Step 1's INPUT_PATH existence check: unset is OK (no seed);
...
#
# Mirrors commands/ideate.toml Step 4c: read the file read-only into a variable. It MUST
