...
# commands/ideate.toml (W1151; ports upstream G235/W1137).
#
# The platform file-read / question UI is only available inside a live Gemini CLI
...
# consistent with Step 1 / Step 4c in commands/ideate.toml
...
# Mirrors commands/ideate.toml Step 1. Returns @{ Continue; Input; Remainder }.
...
# Mirrors commands/ideate.toml Step 1's INPUT_PATH existence check. Returns $true when OK
...
# Mirrors commands/ideate.toml Step 4c. Reads read-only; MUST NOT modify the file.
